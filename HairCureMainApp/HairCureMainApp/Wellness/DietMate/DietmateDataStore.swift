...
class DietmateDataStore {
    ...
    func seedFoods() {
        ...
        let seeds: [FoodSeed] = [
            ...
            FoodSeed(name:"Methi Thepla",                img:"methi",      isVeg:true,  calMin:250,calMax:270,protein:7, carbs:36,fat:8, vitamins:9.2,serving:150, biotin:false,zinc:false,iron:true, omega3:false,vitA:true,  meals:[.breakfast,.lunch]),
            FoodSeed(name:"Moong Dal Chilla",            img:"moongDaalChilla",      isVeg:true,  calMin:220,calMax:250,protein:12,carbs:30,fat:5, vitamins:7.4,serving:150, biotin:true, zinc:true, iron:true, omega3:false,vitA:false, meals:[.breakfast,.lunch]),
