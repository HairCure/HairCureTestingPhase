...
//  HairCure
//
//  List view for a Hair Insights section — iOS 18+ native
//  Uses InsightImage for thumbnails: shows real image when mediaURL is set,
//  branded gradient placeholder otherwise.
//
//
